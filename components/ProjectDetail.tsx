  ...
  if (!project) {
    return (
      <div className="px-6 lg:px-20 py-12 max-w-5xl mx-auto text-center">
        <h2 className="text-2xl font-bold mb-4">{t('project_not_found')}</h2>
        <button 
          onClick={onBack}
  ...
  return (
    <div className="px-6 lg:px-20 py-12 max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      >
        ...
        <span className="text-xs font-bold uppercase tracking-widest">{t('btn_back_projects')}</span>
      </button>
      ...
      <div className="mb-12">
        ...
        <div className="flex items-center space-x-4 text-sm text-gray-500 mono uppercase tracking-widest">
          <span>{t('label_date')}: {resolveTranslation(project.date)}</span>
          <span className="w-1 h-1 bg-gray-700 rounded-full"></span>
          <span>{t('label_status')}: {t('status_active')}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-12">
          <section>
            <h2 className="text-xl font-bold mb-6 text-white border-l-2 border-blue-500 pl-4 uppercase tracking-wider">{t('section_overview')}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-6 text-white border-l-2 border-blue-500 pl-4 uppercase tracking-wider">{t('section_methodology')}</h2>
        ...
        <div className="space-y-8">
          <div className="glass p-6 rounded-2xl border border-white/5">
            <h3 className="text-sm font-bold mb-4 uppercase tracking-widest text-gray-300">{t('label_resources')}</h3>
            <div className="space-y-3">
              <a href="#" className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all group">
                <span className="text-xs font-medium text-gray-400 group-hover:text-white">{t('label_doc')}</span>
                <span className="text-gray-600 group-hover:text-blue-400">↓</span>
              </a>
              <a href="#" className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all group">
                <span className="text-xs font-medium text-gray-400 group-hover:text-white">{t('label_github')}</span>
                <span className="text-gray-600 group-hover:text-blue-400">↗</span>
              </a>
              <a href="#" className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all group">
                <span className="text-xs font-medium text-gray-400 group-hover:text-white">{t('label_demo')}</span>
                <span className="text-gray-600 group-hover:text-blue-400">⛁</span>
              </a>
            </div>
          </div>
          ...
          <div className="glass p-6 rounded-2xl border border-white/5">
            <h3 className="text-sm font-bold mb-4 uppercase tracking-widest text-gray-300">{t('label_project_info')}</h3>
            <div className="bg-black/40 p-4 rounded-xl border border-white/5">
              <div className="space-y-2">
                <div className="flex justify-between text-[10px] uppercase tracking-widest">
                  <span className="text-gray-500">{t('label_role')}</span>
                  <span className="text-gray-300">Lead Developer</span>
                </div>
                <div className="flex justify-between text-[10px] uppercase tracking-widest">
                  <span className="text-gray-500">{t('label_stack')}</span>
                  <span className="text-gray-300">React, WebGPU, Node.js</span>
                </div>
                <div className="flex justify-between text-[10px] uppercase tracking-widest">
                  <span className="text-gray-500">{t('label_client')}</span>
